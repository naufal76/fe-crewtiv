    ...
    <main className="bg-[url('/hero-bg.png')] bg-cover bg-center bg-black text-white pt-3 lg:pt-5">
      ...
      <section className="max-w-6xl mx-auto mt-20 px-6 py-20 text-center">
        ...
        <p className="text-white/80 leading-relaxed max-w-3xl mx-auto">
          Media sosial adalah salah satu channel marketing paling efektif untuk
          membangun brand awareness, menjangkau lebih banyak audiens, dan
      ...
      <section className="text-center mt-30 max-w-7xl mx-auto px-6 py-10">
        ...
        <p className="text-white/80 max-w-3xl mx-auto mb-16">
          Pilih paket pengelolaan media sosial yang sesuai dengan kebutuhan
          brand Anda.
        </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
          <div className="bg-white/5 py-10 px-5 rounded-2xl hover:shadow-[0_0_30px_#f22a98] transition">
            ...
            <p className="text-white/70 text-sm">
              Kami menganalisis brand, target audiens, dan membuat strategi
              konten.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-black/70 text-sm">
                Kami dapat membantu mengelola berbagai platform media sosial
                seperti Instagram, TikTok, Facebook, dan platform lainnya sesuai
                dengan kebutuhan bisnis atau personal branding Anda.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                Ya, setiap paket sudah termasuk perencanaan konten, riset
                hashtag, serta kalender konten agar postingan lebih terarah dan
                memiliki peluang menjangkau audiens yang lebih luas.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                Ya. Pada paket tertentu kami menyediakan laporan analisis
                performa konten setiap bulan sehingga Anda dapat melihat
                perkembangan akun media sosial secara lebih jelas.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <p className="text-black/80 mb-6 max-w-xl">
              Diskusikan strategi konten terbaik untuk bisnis Anda bersama tim
              Crewtiv, dan temukan pendekatan kreatif yang mampu meningkatkan
              visibilitas brand, memperkuat komunikasi dengan audiens, serta
              menghadirkan hasil yang relevan dan berkelanjutan bagi
