...
import { graphicDesignPackages as packages } from "@/constants";
    ...
    <main className="bg-[url('/hero-bg.png')] bg-cover bg-center bg-black text-white pt-30 lg:pt-10">
        ...
        >
          <div className="max-w-xl">
            ...
            <p className="text-white/80 text-lg">
              ...
              <strong>jasa desain grafis profesional </strong>
              untuk UMKM, startup, hingga perusahaan. Desain yang kami buat
              dirancang unik, mudah diingat, dan mampu merepresentasikan
              identitas brand Anda secara kuat dan profesional.
            </p>
      ...
      <section className="max-w-6xl mx-auto mt-20 px-6 py-20 text-center">
        ...
        <p className="text-white/80 leading-relaxed max-w-3xl mx-auto">
          Desain grafis adalah fondasi utama dalam membangun identitas brand
          yang kuat. Lebih dari sekadar tampilan visual, desain grafis membantu
          menyampaikan pesan, nilai, dan karakter bisnis kamu dengan cara yang
          konsisten dan mudah dikenali. Mulai dari logo, tipografi, palet warna,
          hingga konten media sosial, setiap elemen visual bekerja bersama untuk
          menciptakan kesan profesional yang meningkatkan kepercayaan audiens
          terhadap brand kamu.
        </p>

        <p className="text-white/80 leading-relaxed max-w-3xl mx-auto mt-4">
          Dengan desain grafis yang tepat, brand kamu tidak hanya tampil
          menarik, tetapi juga mampu membedakan diri dari kompetitor dan
          membangun hubungan emosional dengan pelanggan. Visual yang dirancang
          secara strategis akan membuat pesan lebih mudah diingat, meningkatkan
          engagement, serta memperkuat citra brand di berbagai platform digital
          maupun offline. Inilah alasan mengapa investasi pada desain grafis
          adalah langkah penting untuk pertumbuhan bisnis yang berkelanjutan.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto mt-10 px-6 py-50 text-center">
        ...
        <p className="text-white/80 leading-relaxed max-w-4xl mx-auto mb-10">
          Proses pengerjaan desain grafis di Crewtiv dilakukan secara
          terstruktur mulai dari memahami kebutuhan brand hingga finalisasi
          desain. Kami memastikan setiap desain memiliki konsep yang jelas,
          visual yang menarik, serta mampu menyampaikan pesan brand secara
          efektif di berbagai media digital maupun cetak.
        </p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
          <div className="bg-white/5 py-10 px-5 rounded-2xl hover:shadow-[0_0_30px_#f22a98] transition">
            ...
            <p className="text-white/70 text-sm">
              Kami memahami kebutuhan desain Anda, mulai dari tujuan, target
              audiens, hingga konsep visual yang diinginkan.
            </p>
          </div>
          ...
          <div className="bg-white/5 py-10 px-5 rounded-2xl hover:shadow-[0_0_30px_#f22a98] transition">
            ...
            <p className="text-white/70 text-sm">
              Tim desainer membuat konsep visual yang sesuai dengan karakter
              brand dan kebutuhan media yang akan digunakan.
            </p>
          </div>
          ...
          <div className="bg-white/5 py-10 px-5 rounded-2xl hover:shadow-[0_0_30px_#f22a98] transition">
            ...
            <p className="text-white/70 text-sm">
              Kami melakukan penyesuaian desain berdasarkan feedback Anda agar
              hasil akhir benar-benar sesuai dengan ekspektasi.
            </p>
          </div>
          ...
          <div className="bg-white/5 py-10 px-5 rounded-2xl hover:shadow-[0_0_30px_#f22a98] transition">
            ...
            <p className="text-white/70 text-sm">
              Desain final dikirim dalam berbagai format siap pakai untuk
              kebutuhan digital maupun cetak.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-black/70 text-sm">
                Kami menyediakan berbagai layanan desain grafis seperti desain
                logo, branding identity, desain social media, poster, banner,
                hingga kebutuhan visual untuk bisnis maupun personal branding.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                Waktu pengerjaan tergantung jenis desain dan tingkat
                kompleksitas proyek. Umumnya proses desain membutuhkan waktu
                sekitar 2–10 hari kerja hingga hasil final siap digunakan.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                Tentu. Kami menyediakan revisi sesuai dengan paket yang dipilih
                agar hasil desain benar-benar sesuai dengan konsep dan kebutuhan
                brand Anda.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                File desain akan diberikan dalam berbagai format seperti PNG,
                JPG, PDF, atau file source sesuai kebutuhan sehingga dapat
                digunakan untuk keperluan digital maupun cetak.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-black/70 text-sm">
                Ya. Semua desain dibuat dengan standar profesional sehingga
                dapat digunakan untuk berbagai kebutuhan seperti social media,
                website, banner, kemasan produk, maupun materi promosi lainnya.
              </p>
            </div>
          </div>
        </section>
