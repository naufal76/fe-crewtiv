      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-4">
            <Image src="/logo.png" alt="Crewtiv Logo" width={70} height={70} />
            <h1 className="text-4xl font-bold text-[#f22a98]">Crewtiv</h1>
          </div>

          <p className="text-white/70 text-sm leading-relaxed">
            Solusi kreatif untuk kehadiran digital Anda. Mari bangun sesuatu
        ...
        <div className="flex flex-col gap-3">
          ...
          <Link
            href="/"
            className="text-white/70 hover:text-[#f22a98] transition"
          >
            Home
          </Link>
